...
logger = logging.getLogger("udaconnect-location-microservice")
...
def save_location(location):
    ...
    try:
        ...
        logger.warning(f"Unexpected payload format detected: {location}")
        return
    ...
    with psycopg2.connect(
        ...
        with conn.cursor() as cursor:
            try:
                ...
                logger.error(f"Cannot save location to database. reason: {e}")